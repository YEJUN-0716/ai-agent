...
- 하위 10분위 초과수익 -0.89% · t=-0.54 (n=151)
- 롱숏 스프레드 +0.95% · t=+0.88
...
같은 기계에 **중위 10분위**(45~55%, 신호가 없는 자리)를 넣으면 연 +10.4% (n=139) 가 나온다.
...
이벤트 1377건 중 상위 10분위 154건. 재현: `python scripts/measure_pead.py sealed` · 산수 점검 `... selftest`
