"""EP02 영상 조립. 장면별 오디오 + 화면 → ep02.mp4
...
넣는 곳:
    audio/01.wav ... 13.wav      **2편부터 목소리 클론 TTS.** 장면별로 뽑는다
    clips/12.mp4                 앱 화면 녹화(게이트 유지 / 러너 OFF)
    charts/01_equity.png ...     make_charts.py 산출물
...
BUILD, OUT = HERE / "build", HERE / "ep02.mp4"
...
VISUALS = {1: "01_equity.png",           # 훅 — 5.6 vs 19.5
           3: "04_slots_vs_signals.png",  # 자리 10 vs 신호 7,466
           5: "01_equity.png",            # 결과
           6: "02_cost_sweep.png",        # 비용은 답이 아니었다
           7: "03_yearly.png",            # 해마다
           8: "03_yearly.png",            # 노출 53%
           9: "05_why_skipped.png",       # 자리 41 vs 현금 6,538
           10: "06_six_names.png"}        # 6종목이 자본 90%
