"""EP04 영상 조립. 장면별 오디오 + 화면 → ep04.mp4

EP02 것을 그대로 가져와 장면→화면 표만 바꿨다.
...
넣는 곳:
    audio/01.wav ... 14.wav      **2편부터 목소리 클론 TTS.** 장면별로 뽑는다
    clips/09.mp4                 설계서 5.3절 스크롤 화면 녹화 (선택)
    charts/01-verdict.png ...    make_charts.py 산출물
...
BUILD, OUT = HERE / "build", HERE / "ep04.mp4"

W, H, FPS = 1920, 1080, 30
BG, FG, MUTED = "#0b0f14", "#e6edf3", "#7d8590"

# 장면 → 미리 만들어 둔 화면. 없는 번호는 자동 카드.
# narration.md 의 빈 줄 두 개가 장면 경계다. 여기 번호는 그 순서다.
VISUALS = {1: "01-verdict.png",      # 훅 — 판정 ①X ②△
           3: "08-ic.png",           # 통과선을 양측으로 적었던 사고
           4: "07-delistings.png",   # 매년 죽는 유니버스
           6: "06-bbby.png",         # 같은 심볼, 다른 회사
           7: "05-benchmark.png",    # 기준선 두 줄 — 이 편의 핵심 그림
           8: "02-mde.png",          # 검출력을 먼저 쟀다
           9: "02-mde.png",          # 사전 등록이 틀린 자리
           10: "03-ci.png",          # 위약 줄은 04-placebo.png 로 갈아끼운다
           12: "01-verdict.png"}     # 통과 / 실패 / 미측정
