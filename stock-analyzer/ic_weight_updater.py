...
⚠️ regime_weights 블록도 계속 쓰인다 — 지우지 말 것. 죽은 것은
factor_engine 안의 독자 하나뿐이고, 파일 쪽 독자는 둘이 남아 있다:
modules/analyst_weights 가 ICT 애널리스트 몫을 **오직 여기서만** 가져오고
(총괄 판정의 3.6~4.2%, 2026-08-20 실측), app.py 는 production_weights 가
없을 때 이 블록으로 후퇴한다.
